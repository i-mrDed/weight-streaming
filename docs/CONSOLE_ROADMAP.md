...
| **P7** | **Jan-style chat + Assistant + MCP + Offline-first** — Reasoning Mode จริง (Auto/On/Off), Assistant management, MCP host + tool-calling protocol, **offline-first (ดีกว่า Jan)** | 📋 **วางแผนแล้ว** — `docs/P7_PLAN.md` (2026-08-04) · เริ่มหลัง P6 |
