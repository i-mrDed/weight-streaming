...
- P2 brief: `docs/internal/P2_BRIEF.md` · หลักฐาน P2: `docs/internal/verification-p2/` + `docs/internal/verification-p2-qa/`
...
- **หลักฐาน (evidence):** ไฟล์นี้ + `docs/internal/artifacts/phase-5*` + ผล test/build/i18n ที่รันจริง
- **งานที่เหลือ (ก่อน P6):**
  1. ✅ อัปเดตเอกสาร roadmap (ทำแล้ว)
  2. ✅ QA ตรวจอิสระ P5 (E2E Hub download + honest-telemetry audit + responsive/i18n sweep) — `docs/verification-p5-qa.md` 10 gates PASS (2026-08-03)
  3. ✅ ผู้ใช้ตรวจรับ P5 — P6 เกิดขึ้นจริง (`ef9a2ec` 2026-08-04)
  4. ✅ P6: sync main → backup tag (`feature/dashboard-theme-v1`) → merge --no-ff → route swap → ลบ dashboard_server.py → CHANGELOG — `ef9a2ec` (2026-08-04)
