...
| **P7** | **Jan-style chat + Assistant + MCP + Offline-first** — Reasoning Mode จริง (Auto/On/Off), Assistant management, MCP host + tool-calling protocol, **offline-first (ดีกว่า Jan)** | 🔄 **P7.1–P7.5 backend เสร็จ** (2026-08-04) → `docs/P7_PLAN.md` + `P7.2–P7.5_BRIEF.md` · เหลืองาน frontend UI + QA |
