...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: |
| **-fa on -t 12 --spec-draft-model ~/models/Gemma4-26B-A4B-QAT/MTP/mtp-gemma-4-26B-A4B-it-Q8_0.gguf --spec-type draft-mtp --spec-draft-n-max 2** | `-fa on -t 12 --spec-draft-model ~/models/Gemma4-26B-A4B-QAT/MTP/mtp-gemma-4-26B-A4B-it-Q8_0.gguf --spec-type draft-mtp --spec-draft-n-max 2` | 38.02 | 1986 / n/a | 50.38 | 1218 / n/a | n/a |
