...
| 012 | 2026-08-10 | DeepSeek V4 Flash 0731 (IQ3_XXS 103 GB) | 📋 Prep | **แผนพร้อมลุย** (รอเคลือ่ยดิสก์ + verify llama.cpp รองรับ): 284B/13B active — RAM 64 GB < 103 GB → disk-streaming path (คือจุดของโปรเจค). ประมาณการ 2-5 tok/s บนเครื่องนี้. Gate ก่อนดาวน์โหลด: ดิสก์ ≥ 110 GB + verify backend. รายละเอียด: EXP-012-dsv4flash-103gb/setup.md |
