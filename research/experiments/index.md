...
| 012 | 2026-08-10 | DeepSeek V4 Flash 0731 (IQ3_XXS 104 GB / 4 shards) | 📋 Prep | **พร้อมลุยครบทุกด้าน** (รอเคลือ่ยดิสก์อย่างเดียว): verify arch `deepseek4` จาก shard-1 metadata จริง + backend b9967 รองรับ (merge 2026-07-07) + gate รองรับ metadata-only shard + hub รองรับ subdir/sharded/Xet (ทดสอบ end-to-end shard 1 ผ่าน) + harness พร้อม (validate restart path แล้ว) + สคริปต์ดาวน์โหลดพร้อม resume. ตัวเลือกไฟล์: unsloth UD-IQ3_XXS 104 GB (เป้า) vs TacoTakumi IQ3_XXS 115 GB (KLD ดีกว่า+imatrix) — เทียบเต็ม: quant-options-comparison.md. ประมาณการ 2-5 tok/s บนเครื่องนี้. รายละเอียด: EXP-012-dsv4flash-103gb/setup.md |
