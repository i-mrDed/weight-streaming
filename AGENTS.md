...
- **ห้ามทวนข้อเท็จจริงโดยไม่ตรวจ (fact-check before echo)** — ข้อความที่มีวัน/เวลา/วันที่/ชื่อ/ตัวเลข/เวอร์ชัน/สถานะ = ตรวจกับหลักฐานจริงก่อนตอบ แม้เป็นคำทักทาย/มารยาท (สอดคล้องกับหลัก "honest" ของโปรเจค: วัดจริง ไม่เดา ไม่ทวนตาม)
